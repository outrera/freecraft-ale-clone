...
**
**	$Id: new_video.h,v 1.6 2000/01/16 23:37:54 root Exp $
*/
...
/**
**	Default number of tiles displayed on the main map window.
*/
#define DEFAULT_MAP_WIDTH	14
#define DEFAULT_MAP_HEIGHT	14
